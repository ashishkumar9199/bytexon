    ...
    return (
      <div className="relative py-12 px-6 text-center space-y-8 overflow-hidden bg-slate-900 border-2 border-slate-950 rounded-3xl shadow-[0_20px_50px_rgba(99,102,241,0.25)] text-white">
        ...
        <div className="space-y-4 max-w-lg mx-auto relative z-10">
          <div className="inline-flex items-center space-x-2 bg-indigo-500/10 border border-indigo-400/30 px-3.5 py-1.5 rounded-full text-indigo-300 text-[10px] font-mono font-bold uppercase tracking-widest animate-pulse">
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden pb-12">
      ...
      <section className="bg-white border-b border-slate-200 py-12 px-6 sm:px-12 relative overflow-hidden z-10">
        <div className="max-w-4xl mx-auto text-center space-y-4 relative z-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-display font-extrabold text-slate-900 tracking-tight uppercase">
            ...
            <div className="bg-white border-2 border-slate-900 rounded-2xl p-6 space-y-5 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] h-full">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="font-display font-black text-xs text-slate-900 uppercase">Input parameters</h4>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="font-display font-black text-xs text-slate-900 uppercase">Secure tracking id</h4>
                    <p className="text-[11px] text-slate-500 leading-relaxed font-sans mt-0.5">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="font-display font-black text-xs text-slate-900 uppercase">Direct Architect Chat</h4>
                    <p className="text-[11px] text-slate-500 leading-relaxed font-sans mt-0.5">
            ...
            <div className="bg-white border-2 border-slate-900 rounded-3xl p-6 sm:p-8 shadow-[8px_8px_0px_0px_rgba(15,23,42,1)]">
              ...
              <div className="flex bg-slate-100 p-1.5 rounded-2xl border-2 border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] mb-8">
                <button 
                  ...
                  className={`flex-1 text-center py-3 text-[10px] sm:text-xs uppercase tracking-widest font-black transition-all cursor-pointer rounded-xl font-display ${
                    bentoTab === 'create' 
                ...
                {isLaunching ? (
                  ...
                  >
                    {!successRequest ? (
                      <form onSubmit={handleFormSubmit} className="space-y-4">
                        ...
                        >
                          <label className="block text-slate-500 text-[10px] font-mono font-bold uppercase tracking-widest flex items-center space-x-1.5">
                          ...
                          <input 
                            ...
                            className="bg-transparent text-slate-950 w-full font-mono text-xs focus:outline-none uppercase placeholder:text-slate-350"
                          />
                        </motion.div>
                        ...
                        >
                          ...
                          <textarea 
                            ...
                            className="bg-transparent text-slate-950 w-full font-mono text-xs focus:outline-none uppercase placeholder:text-slate-350 resize-none"
                          />
                        </motion.div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          <div className="sm:col-span-1 border-2 border-slate-900 rounded-xl p-3 bg-white shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]">
                            <label className="block text-slate-500 text-[10px] font-mono font-bold uppercase tracking-widest mb-1">Currency</label>
                            <select 
                              value={formData.budgetCurrency}
                              onChange={(e) => setFormData(prev => ({ ...prev, budgetCurrency: e.target.value as 'INR' | 'USD' }))}
                              className="bg-white text-slate-900 w-full font-mono text-xs focus:outline-none uppercase cursor-pointer"
                            >
                          ...
                          >
                            <label className="block text-slate-500 text-[10px] font-mono font-bold uppercase tracking-widest">Estimated Budget *</label>
                            <input 
                              type="number"
                              required
                              min="1"
                      ...
                      >
                        ...
                        <div className="bg-emerald-50/40 p-5 border-2 border-slate-900 space-y-3 rounded-2xl relative shadow-[4px_4px_0px_0px_rgba(16,185,129,0.2)]">
                          <span className="text-slate-400 text-[9px] font-bold uppercase tracking-widest block font-mono">WORKSPACE SECURE TICKET ID</span>
                          
                          <div className="flex items-center justify-center space-x-2.5">
                            <strong className="text-2xl font-mono text-indigo-700 tracking-widest font-black select-all">{successRequest.id}</strong>
                            <button
                          ...
                          {copiedId && <span className="text-[9px] font-mono text-emerald-600 uppercase font-bold block animate-pulse">Copied to Clipboard!</span>}
                        </div>
                        ...
                        <div className="space-y-4 pt-4">
                          ...
                          <button
                            ...
                            className="w-full bg-transparent text-slate-500 hover:text-slate-950 font-bold py-2 px-4 uppercase text-[10px] tracking-wider transition-colors cursor-pointer font-mono"
                          >
                            [ SUBMIT NEW PROPOSAL ]
                          </button>
                        </div>
                  ...
                  >
                    ...
                    <form onSubmit={handleTrackById} className="space-y-3">
                      <label className="block text-slate-500 text-[10px] font-bold uppercase tracking-widest font-mono">Track with Project ID</label>
                      <div className="flex gap-3">
                        <input 
                          type="text"
                          required
                    ...
                    <form onSubmit={handleTrackByEmail} className="space-y-3">
                      <label className="block text-slate-500 text-[10px] font-bold uppercase tracking-widest font-mono">Search Registered Email</label>
                      <div className="flex gap-3">
                        <input 
                          type="email"
                          required
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      {matchingRequests.length > 0 && (
                        ...
                        >
                          <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest font-mono">Select Workspace:</p>
