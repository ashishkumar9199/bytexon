...
export default function LaptopIntro({ onComplete }: LaptopIntroProps) {
 ...
 exit={{ opacity: 0, y: -10 }}
 onClick={handleSkip}
 className="absolute top-6 right-6 z-50 border-2 border-slate-800 hover:border-indigo-500 bg-slate-900/90 px-4 py-2 rounded-xl text-slate-400 hover:text-white text-xs font-bold transition-all cursor-pointer flex items-center space-x-2 shadow-[4px_4px_0px_0px_rgba(30,41,59,1)] active:translate-y-0.5 active:shadow-[2px_2px_0px_0px_rgba(30,41,59,1)]"
 >
 ...
 <span className="font-bold text-[10px]">Bytexon Diagnostic BIOS</span>
 </div>
 ...
 <span className="text-[8px] font-bold font-mono text-slate-900">BYTEXON</span>
 </div>
 <div className="flex items-center space-x-2 text-[5px] font-mono font-bold text-slate-400 ">
 <span>SERVICES</span>
 <span>•</span>
 ...
 <div className="inline-flex items-center space-x-1 bg-indigo-50 border border-indigo-100 px-2 py-0.5 rounded-full text-[4px] font-bold text-indigo-700 font-mono">
 <Sparkles className="w-1.5 h-1.5 text-indigo-600 animate-pulse" />
 <span>Elite Digital Architects</span>
 </div>
 <h2 className="text-[12px] sm:text-[13px] font-sans font-bold text-slate-900 leading-tight max-w-[280px]">
 ...
 <span className="text-[5px] font-bold font-mono text-indigo-600 block ">Full-Stack Server</span>
 <p className="text-[3.5px] text-slate-400 font-sans leading-none">Express API orchestrator with high speed routing.</p>
 </div>
 <div className="bg-white border border-slate-200/80 p-1.5 rounded-lg text-left space-y-0.5 shadow-sm">
 <span className="text-[5px] font-bold font-mono text-emerald-600 block ">Secure Database</span>
 <p className="text-[3.5px] text-slate-400 font-sans leading-none">Firestore persistence under isolated security rules.</p>
 </div>
 <div className="bg-white border border-slate-200/80 p-1.5 rounded-lg text-left space-y-0.5 shadow-sm">
 <span className="text-[5px] font-bold font-mono text-cyan-600 block ">Real-Time Chat</span>
 ...
 >
 <div className="inline-flex items-center space-x-2 border border-indigo-400/30 bg-indigo-500/5 px-4 py-1.5 rounded-full text-indigo-300 text-xs font-bold ">
 ...
 <button
 onClick={handlePowerOn}
 className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-500 hover:to-pink-500 text-white font-bold py-4 px-8 rounded-2xl border-2 border-slate-950 text-xs flex items-center space-x-3 transition-all cursor-pointer shadow-[0_0_30px_rgba(99,102,241,0.4)] hover:shadow-[0_0_45px_rgba(99,102,241,0.6)] hover:-translate-y-0.5 active:translate-y-0.5"
 >
