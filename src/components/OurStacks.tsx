...
export default function OurStacks({ onPlanProject }: OurStacksProps) {
 ...
 <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-100 to-cyan-200 border-2 border-slate-900 px-4 py-1.5 rounded-2xl text-slate-900 text-xs font-bold font-mono shadow-[3px_3px_0px_0px_rgba(15,23,42,1)]">
 ...
 <div>
 <span className="text-[9px] font-mono font-bold bg-indigo-100 text-indigo-700 border-2 border-slate-900 px-3 py-1 rounded-xl shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]">
 INTERACTIVE ARCHITECTURE MATCHER
 </span>
 <h2 className="text-xl sm:text-2xl font-sans font-bold text-slate-900 mt-2.5">
 ...
 className={`px-4 py-2 text-xs font-mono font-bold rounded-xl border-2 transition-all cursor-pointer ${
 ...
 <p className="text-xs font-mono text-indigo-600 font-bold bg-indigo-50 border border-indigo-200 px-2.5 py-1 rounded-lg w-fit">
 ...
 <span className="text-xs font-bold text-slate-900 font-mono tracking-wide">{selectedBlueprint.idealScale}</span>
 </div>
 </div>

 <div className="pt-2">
 <span className="text-[9px] font-mono font-bold text-slate-450 block mb-1.5">
 ...
 <span className="text-[9px] font-mono font-bold text-slate-450 flex items-center gap-2 border-b border-slate-200 pb-2.5">
 ...
 {/* Frontend Tier */}
 <div className="space-y-2">
 <span className="text-[9px] font-mono font-bold text-slate-450 block">// FRONTEND TIER_</span>
 <div className="flex flex-wrap gap-2">
 {selectedBlueprint.techChoices.frontend.map(tech => (
 <span key={tech} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border-2 border-slate-900 text-slate-900 font-mono text-[10px] font-bold rounded-xl shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] hover:bg-indigo-50 transition-colors cursor-default">
 ...
 {/* Backend Tier */}
 <div className="space-y-2">
 <span className="text-[9px] font-mono font-bold text-slate-450 block">// BACKEND PIPELINE_</span>
 <div className="flex flex-wrap gap-2">
 {selectedBlueprint.techChoices.backend.map(tech => (
 <span key={tech} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border-2 border-slate-900 text-slate-900 font-mono text-[10px] font-bold rounded-xl shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] hover:bg-cyan-50 transition-colors cursor-default">
 ...
 {/* Database Tier */}
 <div className="space-y-2">
 <span className="text-[9px] font-mono font-bold text-slate-450 block">// DATABASE PERSISTENCE_</span>
 <div className="flex flex-wrap gap-2">
 {selectedBlueprint.techChoices.database.map(tech => (
 <span key={tech} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border-2 border-slate-900 text-slate-900 font-mono text-[10px] font-bold rounded-xl shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] hover:bg-amber-50 transition-colors cursor-default">
 ...
 {/* Infrastructure Tier */}
 <div className="space-y-2">
 <span className="text-[9px] font-mono font-bold text-slate-450 block">// CONTAINER INFRA & CI/CD_</span>
 <div className="flex flex-wrap gap-2">
 {selectedBlueprint.techChoices.infra.map(tech => (
 <span key={tech} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border-2 border-slate-900 text-slate-900 font-mono text-[10px] font-bold rounded-xl shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] hover:bg-emerald-50 transition-colors cursor-default">
 ...
 <div className="space-y-2">
 <span className="text-[9px] font-mono font-bold text-slate-450 block">// COGNITIVE REASONING_</span>
 <div className="flex flex-wrap gap-2">
 {selectedBlueprint.techChoices.ai.map(tech => (
 <span key={tech} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-purple-50 border-2 border-slate-900 text-purple-950 font-mono text-[10px] font-bold rounded-xl shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] hover:bg-purple-100 transition-colors cursor-default">
 ...
 className={`px-4 py-1.5 text-[10px] font-mono font-bold rounded-xl transition-all cursor-pointer ${
 activeCategory === cat
 ...
 <div className="absolute top-4.5 right-4 text-[8px] font-mono font-bold bg-slate-50 border-2 border-slate-900 px-2 py-0.5 rounded-lg text-slate-700 ">
 {tech.badge}
 </div>

 <div className="space-y-1.5">
 <div className="text-[9px] font-mono font-bold text-indigo-650 ">
 // {displayCat}_
 </div>
