    ...
    <div className="min-h-screen bg-slate-50 flex flex-col selection:bg-indigo-500 selection:text-white pb-16">
      ...
      <section className="bg-white border-b-4 border-slate-900 py-20 px-6 sm:px-12 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-emerald-100 to-emerald-200 border-2 border-slate-900 px-4 py-1.5 rounded-2xl text-slate-900 text-xs font-black font-mono tracking-wider uppercase shadow-[3px_3px_0px_0px_rgba(15,23,42,1)]">
              ...
              return (
                <div key={step.id} className="relative">
                  ...
                  <button 
                    ...
                    className={`absolute -left-[41px] top-1.5 w-9 h-9 rounded-full border-2 flex items-center justify-center font-mono text-xs font-black cursor-pointer transition-all ${
                      isSelected
                  ...
                  >
                    ...
                    <h3 className="font-display font-black text-slate-900 text-sm tracking-tight mt-1.5 uppercase group-hover:text-emerald-600 transition-colors">
                      {step.title}
                    </h3>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex items-center justify-between border-b-2 border-slate-100 pb-6 gap-4">
                ...
                <div className="bg-slate-100 border-2 border-slate-900 px-3 py-1.5 rounded-xl text-slate-900 text-xs font-black font-mono uppercase shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] shrink-0">
              ...
              <div className="bg-indigo-50/70 border-2 border-slate-900 rounded-2xl p-5 space-y-3 shadow-[4px_4px_0px_0px_rgba(99,102,241,0.15)]">
                <h4 className="text-[9px] font-mono font-black uppercase tracking-widest text-indigo-900 flex items-center gap-1.5">
                  <UserCheck className="w-4 h-4 text-indigo-600 stroke-[2.5]" />
                  <span>CLIENT ACCOUNTABILITY WORKFLOW_</span>
                </h4>
                <p className="text-xs text-slate-700 leading-relaxed font-sans font-semibold uppercase">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
                ...
                <div className="space-y-3.5">
                  <h4 className="text-[10px] font-mono font-black uppercase tracking-widest text-slate-450 border-l-2 border-slate-900 pl-2">
                    // DELIVERABLES_
                  </h4>
                  <div className="space-y-2">
                    {selectedStep.deliverables.map((del, i) => (
                      <div key={i} className="flex items-start gap-3 text-[10px] font-mono font-black uppercase text-slate-800 bg-slate-50 border-2 border-slate-900 p-3.5 rounded-2xl shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]">
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="space-y-2">
                    {selectedStep.checklist.map((item, i) => (
                      <div key={i} className="flex items-start gap-3 text-[10px] font-mono font-black uppercase text-slate-800 bg-slate-50 border-2 border-slate-900 p-3.5 rounded-2xl shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]">
                        <div className="w-4 h-4 rounded-md border-2 border-slate-900 flex items-center justify-center text-[8px] text-indigo-600 font-black shrink-0 bg-white">
                          ✓
                        </div>
