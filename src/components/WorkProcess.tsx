  ...
  return (
    <div className="min-h-screen bg-[#fbfbfd] text-slate-900 selection:bg-indigo-500/10 selection:text-indigo-900 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 text-center space-y-4">
        <span className="text-xs font-semibold text-indigo-600 tracking-widest uppercase">AGILE LIFECYCLE</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="relative pl-6 border-l border-slate-200 space-y-4 ml-4">
              ...
              return (
                <div key={step.id} className="relative">
                  ...
                  >
                    ...
                    <h3 className="font-bold text-[#1d1d1f] text-sm mt-2 transition-colors">
                      {step.title}
                    </h3>
        ...
        <div className="lg:col-span-7">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-6 gap-4">
                ...
                <div className="bg-slate-50 border border-slate-200/60 px-3 py-1.5 rounded-full text-slate-600 text-xs font-semibold shrink-0">
              ...
              <div className="bg-indigo-50/30 border border-indigo-100/50 rounded-2xl p-5 space-y-2">
                <h4 className="text-[10px] font-bold text-indigo-700 flex items-center gap-1.5 uppercase">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {selectedStep.deliverables.map((del, i) => (
                      <div key={i} className="flex items-start gap-2.5 text-xs text-slate-600 bg-slate-50 border border-slate-200/30 p-3.5 rounded-2xl">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {selectedStep.checklist.map((item, i) => (
                      <div key={i} className="flex items-start gap-2.5 text-xs text-slate-600 bg-slate-50 border border-slate-200/30 p-3.5 rounded-2xl">
                        <div className="w-4 h-4 rounded border border-slate-300 flex items-center justify-center text-[8px] text-indigo-600 font-bold shrink-0 bg-white mt-0.5">
                          ✓
                        </div>
