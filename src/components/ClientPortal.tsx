...
export default function ClientPortal({ requestId, onBack, adminConfig }: ClientPortalProps) {
 ...
 <h2 className="text-sm font-sans font-bold text-slate-900 mb-1">Access Denied</h2>
 ...
 <h1 className="text-xl sm:text-2xl font-sans font-bold text-slate-900 leading-tight ">
 ...
 <h2 className="text-xs font-bold text-slate-900 mb-4 pb-2 border-b border-slate-200 flex items-center space-x-1.5">
 ...
 <dd className="text-slate-900 mt-1 text-xs font-bold ">{request.companyName}</dd>
 </div>
 )}
 <div>
 ...
 <p className="text-lg font-sans font-bold text-slate-900 mt-0.5">
 ...
 className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 hover:text-white text-white font-mono font-bold text-xs transition-all flex items-center justify-center space-x-1.5 cursor-pointer"
 >
 {submittingPayment ? (
 <>
 ...
 <div>
 <h4 className="font-bold text-slate-900 text-xs font-mono">Payment proof under audit</h4>
 ...
 <div>
 <h3 className="font-bold text-slate-900 text-xs tracking-wide">Bytexon Lead Architect</h3>
 ...
 <div className="px-2 py-0.5 bg-slate-50 border border-slate-200 text-[9px] text-slate-500 font-bold font-mono ">
 Live Console
 </div>
 </div>
 ...
 <p className="text-xs font-bold text-slate-900 font-mono">Console session opened</p>
